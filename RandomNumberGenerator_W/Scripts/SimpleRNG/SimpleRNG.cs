...
namespace SimpleRNGLibrary
{
    ...
    {
        //Save/Load these two, if you want to save the RNG state
        ...
        public float GetFloatRange(float _min, float _max) //exclusive
        {
            double rand = GetUniform();
            float randFloatRange = (float)(_min + (_max-_min) * rand);
            return randFloatRange;
        }
        
        public int GetIntRange(int _min, int _max) //inclusive
        {
            double rand = GetUniform();
            int randIntRange = Mathf.RoundToInt((float)(_min + (_max-_min) * rand));
            return randIntRange;
        }
